...
def batch_predict(texts, model_path='sentiment_model_lr.pkl', vectorizer_path='tfidf_vectorizer.pkl'):
    """
...
def home():
    ...
    <html>
        ...
        <body>
            ...
            <textarea id="textInput" placeholder="Enter text to analyze">I love this app, it's amazing!</textarea>
